...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getMove(self, category,obscurePhrases,guessed):
        temp_sort = [x for x in self.SORTED_FREQUENCIES]
        ...
        if scf == True:
            ...
            return random.choice(temp_sort)
...
def spinWheel():
    with open("json files/wheel.json", 'r') as f:
...
def getRandomCategoryAndPhrase():
    with open("json files/phrases.json", 'r') as f:
